...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      ...
      >
        <Card className="border-[var(--ng-primary)]/20 hover:border-[var(--ng-primary)]/50 transition-colors cursor-pointer group" onClick={() => handleLogin("student")}>
          <CardHeader className="text-center pb-2">
            <div className="w-16 h-16 bg-[var(--ng-primary)]/10 text-[var(--ng-primary)] rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
        ...
        <Card className="border-[var(--ng-secondary)]/20 hover:border-[var(--ng-secondary)]/50 transition-colors cursor-pointer group" onClick={() => handleLogin("recruiter")}>
          <CardHeader className="text-center pb-2">
            <div className="w-16 h-16 bg-[var(--ng-secondary)]/10 text-[var(--ng-secondary)] rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
